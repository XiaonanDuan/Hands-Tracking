function B=forwardpropagation (del_row, del_col, ~,skin_map, B, current_index)

%find all blob location indices in the next frame for intersection
index_blobs=[];
sz=size(skin_map{1});
...
%     plot(curr_blob(:,2),curr_blob(:,1),'b.');
% end
% title('Next frame with propagated blobs')
% hold off
% 
